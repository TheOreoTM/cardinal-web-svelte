<script lang="ts">
	...
	//Redirect name
	$: pageName = NavbarItems.filter((item) => item.href === to)[0]?.title;
</script>

<div
	class="flex flex-col justify-center place-items-center space-y-6 h-screen w-screen text-white px-6"
>
